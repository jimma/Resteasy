...
@RunAsClient
public class SseDeadLockTest
{

    private static final Logger logger = Logger.getLogger(SseDeadLockTest.class);

    @Deployment
    public static Archive<?> deploy()
    {
        WebArchive war = TestUtil.prepareArchive(SseDeadLockTest.class.getSimpleName());
    ...
    {
        return PortProviderUtil.generateURL(path, SseDeadLockTest.class.getSimpleName());
    }
